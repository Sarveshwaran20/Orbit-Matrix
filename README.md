...
Current Workaround: 1. Set the environment variable OLLAMA_ORIGINS="\*" on your machine to allow cross-origin requests. 2. Click the lock/settings icon next to the URL bar on the hosted site, open Site Settings, and change Insecure Content to Allow.
...
AIzaSyAbKvRR7LD7ToKy8KZjZYw9_296SEAB-uU
